      ...
      <section className="py-8 md:py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            {/* Image */}
            <div className="bg-[#F0FAFE] rounded-2xl p-8 flex items-center justify-center aspect-square">
              {product.imageUrl ? (
              ...
              {product.related.map((rel) => {
                ...
                return (
                  <Link key={rel.id} href={`/producten/${rel.id}`} className="bg-white rounded-xl border border-gray-100 p-4 hover:shadow-md transition-shadow">
                    {rel.imageUrl && (
                      <div className="aspect-square bg-[#F0FAFE] rounded-lg mb-3 flex items-center justify-center p-3">

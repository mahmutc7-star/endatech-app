...
export default async function OgImage() {
  ...
  const bytes = new Uint8Array(logoData);
  let binary = "";
    ...
    (
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: 30, color: "#4b5563", fontWeight: 500, textAlign: "center", marginBottom: 28 }}>
            Betaalbare airco&apos;s · Snel geplaatst · F-Gassen gecertificeerd
          </div>

          <div style={{ width: 80, height: 4, background: "#2563eb", borderRadius: 2, marginBottom: 24 }} />
